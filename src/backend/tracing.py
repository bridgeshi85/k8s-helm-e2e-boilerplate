...
class BaggageToAttributesSpanProcessor(SpanProcessor):
    ...
    Baggage itself isn't queryable in Tempo (it only travels in-band via the
    W3C `baggage` header); this processor is what actually makes a baggage
    value show up as a searchable span attribute.
    """
